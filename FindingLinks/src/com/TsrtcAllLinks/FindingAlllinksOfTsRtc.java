...
public class FindingAlllinksOfTsRtc {
...
//	WebElement header_Block=driver.findElement(By.className("selectedtabcopy"));
	//	Lists<WebElement>header_BlockLinks=header_Block.findElements(By.tagName("a"));
